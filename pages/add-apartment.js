...
//   // Константы
//   const categories = ['Квартира', 'Апартаменты', 'Гостиница', 'Хостел', 'Дом', 'База отдыха', 'Сауна/Баня'];
//   const GOOGLE_API_KEY = "AIzaSyBBFJdnxDmbAko4mbzBzJ-yozBBx_gpY3w";
...
//     } catch (error) {
//       console.error('Ошибка:', error);
//       setSnackbarMessage(error.message || 'Произошла ошибка при добавлении объявления');
//       setSnackbarSeverity('error');
//       setSnackbarOpen(true);
//     } finally {
//       setIsSubmitting(false);
...
//         <FileUploadSlider onFilesSelected={handleFilesSelected} />
