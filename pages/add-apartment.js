...
//     // Проверяем, есть ли метро в выбранном городе
...
//       houseNumber: !formData.houseNumber,
//       district: !formData.district,
//       metro: cityHasMetro && !formData.metro, // Проверяем метро только для городов, где оно есть
//     };
...
//       ...prev, 
//       city,
//       metro: '', // Сбрасываем выбранное метро
...
//   apartmentInfo={apartmentInfo}
//   photoError={photoError}
//   key={`${previewOpen}-${JSON.stringify(formData)}`} // Добавьте этот ключ
// />
