...
//     // Здесь можно добавить логику для каждого типа действия
//     switch (actionType) {
//       case 'reportOutdated':
...
//         // Здесь можно добавить API вызов для отправки отзыва
//         break;
//       case 'reportProblem':
//         console.log('Report problem for apartment:', id);
//         // Здесь можно добавить API вызов для отправки проблемы
//         break;
//       default:
//         break;
//     }
...
const ApartmentDetailContent = () => {
  ...
  const handleToggleFavorite = async () => {
    ...
    try {
      ...
      showSnackbar(
        newStatus ? t.favoriteAdded : t.favoriteRemoved,
        'success'
      );
    } catch (error) {
