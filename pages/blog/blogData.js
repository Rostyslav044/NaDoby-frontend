...
// // Основная функция getStaticProps для страниц блога
// export async function getStaticProps({ params, locale = 'ua' }) {
// try {
//   const blogData = await getStaticBlogData()
//   let postData = null

//   // Если есть параметр slug, получаем конкретный пост
//   if (params?.slug) {
//     postData = await getBlogPostBySlug(params.slug, locale)
...
//       seoData: blogData.seoData,
//       generatedAt: blogData.generatedAt
//     },
//     // Регенерация страницы каждые 24 часа
//     revalidate: 86400,
//   }
// } catch (error) {
...
//       generatedAt: new Date().toISOString()
//     },
//     revalidate: 3600, // 1 час при ошибке
//   }
// }
// }
...
// return {
//   paths,
//   fallback: 'blocking' // или true для инкрементальной статической регенерации
// }
// }
