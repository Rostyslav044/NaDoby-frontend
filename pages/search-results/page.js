...
// //       // Переводы категорий на украинский
// //       categories: {
// //         'apart': 'Квартира',
// //         'hostel': 'Хостел', 
// //         'glamping': 'Глемпінг',
...
// //             // Определяем категории, по которым ничего не найдено
...
// //           {/* Сообщение о пропущенных категориях */}
...
// //             {/* Переключение вида и сортировка */}
