...
// const CreateUser = ({ onClose, onAuthSuccess }) => {
//   const dispatch = useDispatch();
//   const { register, handleSubmit, reset, formState: { errors } } = useForm();
//   const [message, setMessage] = useState("");
//   const [isLogin, setIsLogin] = useState(true);
...
//       if (result?.error) {
//         setMessage("Ошибка авторизации через Google");
//         setAlertVisible(true);
//       } else {
//         setMessage(t.loginSuccess);
//         setAlertVisible(true);
//         dispatch(login("google_auth_token"));
//         setTimeout(() => {
//           onAuthSuccess();
//         }, 2000);
//       }
...
//         {alertVisible && (
//           <Alert 
//             severity={message.includes("успеш") ? "success" : "error"} 
//             sx={{ mb: 2 }}
