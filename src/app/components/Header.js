...
const translations = {
  ua: "Подобова оренда житла (Квартири, Готелі, Хостели, Будинки, Сауни/Бані, Бази відпочинку) по всій Україні без посередників.",
  ru: " Посуточная аренда жилья (Квартиры, Гостиницы, Хостелы, Дома, Сауны/Бани, Базы отдыха) по всей Украине без посредников.",
};
