...
//   },
//   ru: {
//     slogan: "Посуточная аренда жилья (Квартиры, Гостиницы, Гостинница для животных, Хостелы, Дома, Сауны/Бани, Глемпинг, Пансионат, Котедж для компаний, Коворкинг, Автокемпинг, Базы отдыха) по всей Украине без посредников.",
//     menu: "Меню"
//   }
// };
...
//       {/* Фиксированный слоган */}
//       <div className={styles.sloganFixed}>
//         <p className={styles.homSlogan}>{translations[currentLanguage].slogan}</p>
//       </div>
