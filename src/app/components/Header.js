...
// Добавляем переводы для текста
const translations = {
  ua: "Оренда житла (Квартири, Готелі, Апартаменти, Хостели, Будинки, Сауни/Бані, Бази відпочинку) по всій Україні без посередників.",
  ru: "Аренда жилья (Квартиры, Гостиницы, Апартаменты, Хостелы, Дома, Сауны/Бани, Базы отдыха) по всей Украине без посредников.",
};
