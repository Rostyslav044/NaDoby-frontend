...
const translations = {
  ua: "Подобова оренда житла (Квартири, Готелі, Готель для тварин, Хостели, Будинки, Сауни/Бані, Глемпінг, Пансіонат, Котедж для компній, Коворкінг, Автокемпінг, Бази відпочинку) по всій Україні без посередників.",
  ru: " Посуточная аренда жилья (Квартиры, Гостиницы, Готель для животных, Хостелы, Дома, Сауны/Бани, Глемпинг, Пансионат, Котедж для компаний, Коворкинг, Автокемпинг, Базы отдыха) по всей Украине без посредников.",
};
